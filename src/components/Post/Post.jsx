    ...
    return (
        ...
        <div className=" flex flex-col w-screen lg:w-full h-fit md:mt-20 justify-center items-center">
            ...
            <form onSubmit={handleSubmit} className="w-1/2 h-1/2 px-10 py-5 flex flex-row justify-center items-center">
                <textarea required type="text" rows={2} style={{resize:"none"}} className=" textarea w-48 flex justify-center items-center px-4 py-2 rounded-lg drop-shadow-lg" placeholder="So... What you wanna say?" onChange={handleContent} ></textarea>
