...
const Post = () => {
    ...
    return (
        ...
        <div className=" flex flex-col w-screen lg:w-full h-fit md:mt-20 justify-center items-center">
            ...
            <form onSubmit={handleSubmit} className="w-1/2 h-1/2 px-10 py-5 flex flex-row lg:flex-col lg:justify-between justify-center items-center">
...
What you wanna say?" onChange={handleContent} ></textarea>
                <button className="button px-4 py-2 rounded-lg drop-shadow-lg bg-red-200 lg:mt-5 hover:bg-red-500 transition-all duration-300 hover:text-white ml-4 " type="submit">Post</button>
            </form>
        </div>
        </>
    );
