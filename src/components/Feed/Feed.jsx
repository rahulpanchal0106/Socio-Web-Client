...
import { FaCommentAlt, FaRegComments, FaRemoveFormat } from "react-icons/fa";
    ...
    return (
        <>
            <div className="px-10 relative z-10 py-5 bg-white-200 flex flex-col justify-center items-center">
                ...
                <div className="mt-20 flex flex-col-reverse justify-center items-center">
                            ...
                            <div key={index} className="post bg-gray-100 mb-4 rounded-lg px-4 py-2 w-full drop-shadow-lg">
                                ...
                                <div className="bottom-bar mb-2 flex flex-row  justify-between">
                                    ...
                                    <div className="flex flex-row items-center justify-center transition-all duration-300">
                                        <button className="px-1 w-8" onClick={() => toggleComments(post._id)}>
                                            {showPostComments ? <FaCommentSlash size={14}/> : <FaComment size={14}/>} 
                                        </button>
                                ...
                                {showPostComments && <ul className="bg-white drop-shadow-lg px-2 py-2 rounded-lg">
                                    <div className="relative bottom-5 left-20  " style={{ }}><BiSolidLeftArrow style={{rotate:"90deg"}} color="white" /></div>
                                    {post.post.comments && post.post.comments.length > 0 ? post.post.comments.map((el, i) => {
                                        ...
                                        return (
                                            <div className="flex flex-col mb-4 drop-shadow-lg w-96 px-2 py-4 border border-solid border-gray-200 rounded-lg" key={i}>
                                                ...
                                                <div className="flex w-3/4 py-2 break-all" >
                                                    {el.comment}
                                                </div>
